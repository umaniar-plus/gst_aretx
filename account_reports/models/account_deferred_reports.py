...
#from odoo.addons.account.models.account_move import DEFERRED_DATE_MIN, DEFERRED_DATE_MAX
from datetime import date

DEFERRED_DATE_MIN = date(1970, 1, 1)
DEFERRED_DATE_MAX = date(9999, 12, 31)
